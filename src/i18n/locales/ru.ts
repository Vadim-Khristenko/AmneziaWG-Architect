...
export const ru = {
  ...
  "landing.tools.lede":
    "Два движка, один метод. Всё считается прямо в этой вкладке и никуда не отправляется.",
  ...
  "landing.xray.tag": "новенький",
  "landing.xray.desc":
    "Смотрит сквозь и не даёт заглянуть туда, куда не стоит. Снаружи выглядит как пакет обычного сайта, хотя это не он. Настроек много, крутится и мутится всё. Движок готов, интерфейс собирается.",
  "landing.xray.status": "В работе",
