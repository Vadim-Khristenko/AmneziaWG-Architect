...
export const ru = {
  ...
  "about.what.card.4.desc":
    "У каждого параметра есть примечание: что он делает, обязан ли совпадать с сервером и в какой версии появился. Сорок четыре ответа в FAQ — про то же самое, только подробнее.",
