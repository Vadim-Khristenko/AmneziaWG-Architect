...
export const ru = {
  ...
  "mk.hero.desc":
    "Инструмент читает формат Amnezia `vpn://` и ссылки `vless://`, показывает, что внутри, и говорит, что с этим не так. Ключ может нести несколько протоколов сразу — WireGuard, AmneziaWG, XRay, OpenVPN — и здесь видно каждый.",
  "mk.hero.privacy":
  ...
  "mk.mode.inspect.lede":
    "Вставьте `vpn://` или `vless://`. Ключ будет прочитан, опознан и проверен — ничего никуда не отправляется.",
  "mk.mode.merge.title":
    "Слияние",
  "mk.mode.merge.hint":
